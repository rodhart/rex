...
public class ExamFactory implements ExamFactoryIF {
	 ...
	 * 
	 * @param correct
	 *            boolean: Determines if the AnswerIF is a correct answer
	 * @param text
	 *            SourceIF: The source from the UEF that defines this answer
	 ...
	 * 
	 * @param label
	 *            String: The label given to this BlockIF
	 * @param text
	 *            SourceIF: The source from the UEF that defines this BlockIF
	 ...
	 * 
	 * @param label
	 *            String: The label given to this FigureIF
	 * @param text
	 *            SourceIF: The source from the UEF that defines this FigureIF
	 ...
	 * 
	 * @param correct
	 *            boolean: Determines if the FixedAnswerIF is a correct answer
	 * @param index
	 *            int: The position that this FixedAnswerIF must be placed in.
	 * @param text
	 *            SourceIF: The source from the UEF that defines this
	 *            FixedAnswerIF
	 ...
	 * 
	 * @param version
	 *            String: represents the version identifier for this exam.
	 * @return new instance of ExamIF
	 */
	 ...
	 * 
	 * @param topic
	 *            String: The topic of this ProblemIF
	 * @param label
	 *            String: The label given to this ProblemIF
	 * @param question
	 *            SourceIF: The source from the UEF that defines this ProblemIF
	 * @param answers
	 *            AnswerIF[]: An array of answers for this ProblemIF
	 * @return new instance of ProblemIF
	 * @exception NullPointerException
	 *                If topic, question, answers, or any element in answers is
	 *                null.
	 */
	public ProblemIF newProblem(String topic, String label, SourceIF question,
		...
		if (question == null)
			throw new NullPointerException(
					"The argument question cannot be null");
		if (answers != null) {
			for (int i = 0; i < answers.length; i++)
				if (answers[i] == null)
					throw new NullPointerException(
							"The argument answers cannot contain null values");
		}
