...
%justin johnson and jim cardona
%system testing
%first question does not have a correct answer
\documentclass{exam} 
\usepackage{fullpage}
\usepackage{amsmath}
\usepackage{comment}
...
\begin{problem}[require=example topic]{example topic}{15}
  This is a problem that does not have a correct answer - used for system testing
  \ref{fig:example topic}
  \begin{answers}
    \answer answer 1
    \answer answer 2
    \answer[fixed] fixed answer 3
    \answer[fixed]  fixed answer 4
    \answer answer 5
    \answer[fixed] fixed  answer 6
  \end{answers}
\end{problem}
