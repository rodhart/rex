 ...
 * This exists solely to set up the lexer and parser generated
 * from the ECF grammar.
 *
 * @author Burke Cates
 */
public class EcfParser implements EcfParserIF {
  ...
  /**
   * Parse the given ECF file into a ConfigIF object.
   * @param file the ECF file to be parsed
   * @return Filled in ConfigIF object
   */
